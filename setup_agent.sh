...
TUNNEL_PORT="10000" # Le port que le tunnel va créer sur votre backend (doit être libre)
...
echo "Vérifiez les logs du tunnel Systemd: journalctl -u vps-tunnel.service -n 100"
